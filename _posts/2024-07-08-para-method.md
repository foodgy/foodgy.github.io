...
1. **Projects** (проекты): заметки с&nbsp;чёткими целями и&nbsp;сроками;
2. **Areas** (области): задачи без конечных сроков, отражающие долгосрочные обязанности;
3. **Resources** (ресурсы): полезные материалы и&nbsp;информация для будущего использования;
4. **Archive** (архив): завершённые проекты и&nbsp;устаревшие документы.
