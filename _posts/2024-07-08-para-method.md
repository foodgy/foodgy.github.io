...
{% include image.html img="para-intro.png" alt="Схема метода PARA для организации заметок и повышения продуктивности" %}
...
{% include image.html img="para-method.png" link="" alt="Инфографика метода PARA с четырьмя основными категориями: проекты, области, ресурсы, архив" loading="lazy" %}
...
{% include image.html img="para-example.png" link="" alt="Пример распределения задач по категориям метода PARA в системе заметок" caption="Пример распределения задач по категориям" loading="lazy" %}
...
{% include image.html img="para-workflow.png" link="" alt="Как использовать метод PARA для упрощения управления заметками и повышения продуктивности" loading="lazy" %}
