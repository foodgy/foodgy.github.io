...
{% include image.html
    src="para-intro.png"
    alt="Схема метода PARA для организации заметок и повышения продуктивности"
%}
...
{% include image.html
    src="para-method.png"
    href="para-method.png"
    alt="Инфографика метода PARA с четырьмя основными категориями: проекты, области, ресурсы, архив"
    loading="lazy"
%}
...
{% include image.html
    src="para-example.png"
    href="para-example.png"
    alt="Пример распределения задач по категориям метода PARA в системе заметок"
    caption="Пример распределения задач по категориям"
    loading="lazy"
%}
...
{% include image.html
    src="para-workflow.png"
    href="para-workflow.png"
    alt="Как использовать метод PARA для упрощения управления заметками и повышения продуктивности"
    loading="lazy"
%}
