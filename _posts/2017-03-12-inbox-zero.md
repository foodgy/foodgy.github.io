...
![Человек пытается навести порядок в переполненном почтовом ящике](/assets/img/{{ page.path | remove: '_posts/' | remove: '.md' }}/overworked.png){:fetchpriority="high"}
...
![Советы для организации электронной почты: использование тем, папок и меток](/assets/img/{{ page.path | remove: '_posts/' | remove: '.md' }}/recos.png){:loading="lazy""}
