...
last_modified_at: 2025-01-09 03:00:00 +0300
---
...
<nav aria-label="Table of Contents">
    <details class="font-sans callout">
        ...
        <ol class="list-decimal mt-4 ml-7 mb-4">
...
![Пытается навести порядок в почте](/assets/img/{{ page.path | remove: '_posts/' | remove: '.md' }}/overworked.png){:alt="Человек пытается навести порядок в переполненном почтовом ящике"}
...
{% include image.html file="inbox-zero.png" link="" alt="Инфографика метода Inbox Zero: пять шагов для управления почтой" %}
...
![Zero Inbox](/assets/img/{{ page.path | remove: '_posts/' | remove: '.md' }}/recos.png){:loading="lazy" alt="Советы для организации электронной почты: использование тем, папок и меток"}
