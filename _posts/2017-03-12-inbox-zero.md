...
{% include image.html src="overworked.png" alt="Человек пытается навести порядок в переполненном почтовом ящике" %}
...
{% include image.html src="inbox-zero.png" link="" alt="Инфографика метода Inbox Zero: пять шагов для управления почтой" loading="lazy" %}
...
{% include image.html src="recos.png" alt="Советы для организации электронной почты: использование тем, папок и меток" loading="lazy" %}
